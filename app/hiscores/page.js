            ...
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: isMobile ? '12px' : '24px', marginBottom: isMobile ? '16px' : '40px' }}>
                <div style={{ background: '#111', border: '1px solid #222', borderRadius: '8px', padding: isMobile ? '16px' : '28px', textAlign: 'center' }}>
                  <div style={{ fontSize: isMobile ? '14px' : '18px', fontWeight: '700', color: '#fff', marginBottom: isMobile ? '8px' : '12px', textTransform: 'uppercase', letterSpacing: '1px' }}>Current Week</div>
                  <div style={{ fontSize: isMobile ? '32px' : '48px', fontWeight: '700', color: '#4ade80' }}>{summary.current_total?.toLocaleString() || '-'}</div>
                  <div style={{ fontSize: isMobile ? '12px' : '14px', color: '#fff', marginTop: '8px' }}>Accounts with XP gain</div>
                </div>
                <div style={{ background: '#111', border: '1px solid #222', borderRadius: '8px', padding: isMobile ? '16px' : '28px', textAlign: 'center' }}>
                  <div style={{ fontSize: isMobile ? '14px' : '18px', fontWeight: '700', color: '#fff', marginBottom: isMobile ? '8px' : '12px', textTransform: 'uppercase', letterSpacing: '1px' }}>Week High</div>
                  <div style={{ fontSize: isMobile ? '32px' : '48px', fontWeight: '700', color: '#60a5fa' }}>{summary.week_high?.toLocaleString() || '-'}</div>
                  <div style={{ fontSize: isMobile ? '12px' : '14px', color: '#fff', marginTop: '8px' }}>Peak this week</div>
                </div>
                <div style={{ background: '#111', border: '1px solid #222', borderRadius: '8px', padding: isMobile ? '16px' : '28px', textAlign: 'center' }}>
                  <div style={{ fontSize: isMobile ? '14px' : '18px', fontWeight: '700', color: '#fff', marginBottom: isMobile ? '8px' : '12px', textTransform: 'uppercase', letterSpacing: '1px' }}>Last Week</div>
                  <div style={{ fontSize: isMobile ? '36px' : '56px', fontWeight: '700', color: '#fff' }}>{summary.last_week_total?.toLocaleString() || '-'}</div>
                  <div style={{ fontSize: isMobile ? '12px' : '14px', color: '#888', marginTop: '8px' }}>{summary.last_week_label || ''}</div>
                </div>
              </div>
